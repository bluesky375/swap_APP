...
//  Swap!
//
//  Created by Catalina on 11/21/19.
...
@available(iOS 13.0, *)
@available(iOS 13.0, *)
class NameViewController: UIViewController , UITextFieldDelegate, UIScrollViewDelegate {
    ...
    @IBOutlet weak var txtOccupationDropDown: DropDown!
...
//        self.btnBack.isHidden = true
        ...
        self.txtOccupationDropDown.setLeftPaddingPoints(10)
        self.txtOccupationDropDown.selectedRowColor = UIColor.systemGray
        self.txtOccupationDropDown.rowBackgroundColor = UIColor.systemBackground
        scrollView = UIScrollView()
        scrollView.delegate = self
        scrollView.isScrollEnabled = true
        self.viewContinue.layer.cornerRadius = self.viewContinue.frame.height/2
        self.txtOccupationDropDown.optionArray = [
        "Able Seamen",
        "Account Collector",
        ...
        "Zoo Veterinarian",
        "Zoologist"]
//        self.txtOccupationDropDown.optionIds = [1,2,3,4,5,6,7,8,9]
//        self.txtOccupationDropDown.didSelect { (selectedText , index, id) in
//            self.txtOccupationDropDown.text = "Selected String: \(selectedText) \n index: \(index)"
//        }
        self.txtOccupationDropDown.addSubview(scrollView)
    }
    
    @IBAction func btnContinueAction(_ sender: Any) {
        
        if self.txtFirstName.text!.count == 0 {
            CommonManager.sharedInstance.showAlert(viewCtrl: self, title: NSLocalizedString("warning", comment: ""), msg: NSLocalizedString("pleaseEnterFirstName", comment: ""))
            return
        } else if self.txtLastName.text!.count == 0 {
            CommonManager.sharedInstance.showAlert(viewCtrl: self, title: NSLocalizedString("warning", comment: ""), msg: NSLocalizedString("pleaseEnterLastName", comment: ""))
            return
        }  else if self.txtOccupationDropDown.text!.count == 0 {
            CommonManager.sharedInstance.showAlert(viewCtrl: self, title: NSLocalizedString("warning", comment: ""), msg: NSLocalizedString("pleaseEnterOccupation", comment: ""))
            return
        } else {
            GlobalData.myCard.txtFirstNameNES = self.txtFirstName.text!
            GlobalData.myCard.txtLastNameNES = self.txtLastName.text!
            GlobalData.myCard.txtFullNameNES = self.txtFirstName.text! + " " + self.txtLastName.text!
            UserDefaults.group.set(GlobalData.myCard.txtFullNameNES, forKey: "txtFullNameNES")
            GlobalData.myCard.txtOccupation = self.txtOccupationDropDown.text!
            let vc = storyboard?.instantiateViewController(withIdentifier: "OrganizationViewController") as! OrganizationViewController
